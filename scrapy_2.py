...
if opcao == '1':
    ...
    while linha < 6:
        ...
        reserva_de_torque = tree.xpath('//*[@id="MainContentSection"]/div[17]/div/table/tbody/tr[%d]/td[2]/div/p/text()' %contador)
        eixo_dianteiro = tree.xpath('//*[@id="MainContentSection"]/div[17]/div/table/tbody/tr[%d]/td[3]/div/p/text()' %contador)
        transmissao = tree.xpath('//*[@id="MainContentSection"]/div[17]/div/table/tbody/tr[%d]/td[4]/div/p/text()' %contador)
        vazao_hidraulica = tree.xpath('//*[@id="MainContentSection"]/div[17]/div/table/tbody/tr[%d]/td[5]/div/p/text()' %contador)
        lastro_maximo = tree.xpath('//*[@id="MainContentSection"]/div[17]/div/table/tbody/tr[%d]/td[6]/div/p/text()' %contador)
