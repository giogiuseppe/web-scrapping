...
requisiçao = requests.get('https://www.deere.com.br/pt/tratores/série-8r-270cv-400cv/')

tree = html.fromstring(requisiçao.content)

print()
print('Tratores Grandes Série 8R - John Deere - Digite 1')
...
if opcao == '1':
    ...
    while linha < 6:
        ...
        potencia_maxima = tree.xpath('//*[@id="MainContentSection"]/div[3]/div/table/tbody/tr[%d]/td[2]/div/p/text()' %contador)
        reserva_de_torque = tree.xpath('//*[@id="MainContentSection"]/div[3]/div/table/tbody/tr[%d]/td[3]/div/p/text()' %contador)
        transmissao = tree.xpath('//*[@id="MainContentSection"]/div[3]/div/table/tbody/tr[%d]/td[4]/div/p/text()' %contador)
        eixo_dianteiro = tree.xpath('//*[@id="MainContentSection"]/div[3]/div/table/tbody/tr[%d]/td[5]/div/p/text()' %contador)
        ...
        print("POTÊNCIA MÁXIMA      |     ",potencia_maxima[0])  
